<template>
  <v-row class="my-1">
    ...
    <v-col cols="6">
      <ColumnsAutocomplete ref="columns" v-model="form.key_right_id" />
    </v-col>
    <v-col cols="2">
      <v-btn
        v-if="!relationship"
...
export default {
  ...
  props: {
    ...
    keyLeftId: { type: String, required: true },
    leftColName: { type: String, default: '' },
  ...
  computed: {
    formChanged () {
      return this.relationship &&
        (this.relationship.key_right_id !== this.form.key_right_id || this.relationship.relationship !== this.form.relationship)
    },
  },
  ...
  methods: {
    ...
    fillForm () {
      if (this.relationship) {
        this.form = { key_right_id: this.relationship.key_right_id, relationship: this.relationship.relationship }
        this.$refs.columns.pushColumn(this.relationship.key_right)
      } else {
